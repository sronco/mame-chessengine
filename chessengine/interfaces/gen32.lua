...
function interface.setlevel()
	...
	send_input(":KEY3", 0x01000000, 0.6)	-- CL
	send_input(":KEY3", 0x01000000, 0.6)	-- CL
	send_input(":KEY2", 0x02000000, 0.6)	-- DOWN
	send_input(":KEY3", 0x02000000, 0.6)	-- RIGHT
	send_input(":KEY3", 0x02000000, 0.6)	-- RIGHT
	send_input(":KEY1", 0x01000000, 0.6)	-- ENT
	send_input(":KEY1", 0x01000000, 0.6)	-- ENT
...
function interface.promote(x, y, piece)
	...
	if (right ~= -1) then
		for i=1,right do
			send_input(":KEY3", 0x02000000, 1)	-- RIGHT
		end

		send_input(":KEY1", 0x01000000, 1)	-- ENT
	end
end
