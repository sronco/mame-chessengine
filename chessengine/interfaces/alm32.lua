...
local function proglevel(level)
	...
	while (n<4 and level:match("%s%d%d/%d%d:%d%d") ~= nil) do
		...
		level = level:sub(10)
		send_input(":KEY3", 0x8000, 0.25)	-- ENT
		send_input(":KEY1", 0x4000, 0.25)	-- RIGHT
		send_input(":KEY3", 0x8000, 0.25)	-- ENT
		...
		for i=1,int do
			if (dir>0) then
				send_input(":KEY2", 0x8000, 0.25)	-- UP
				z1=z1+10
			else
				send_input(":KEY2", 0x4000, 0.25)	-- DOWN
				z1=z1-10
			end
		end
		...
		for i=1,math.abs(mod) do
			if (mod>0) then send_input(":KEY1", 0x4000, 0.25)	-- RIGHT
			else send_input(":KEY3", 0x4000, 0.25)			-- LEFT
			end
		end
		send_input(":KEY3", 0x8000, 0.25)	-- ENT
		send_input(":KEY1", 0x4000, 0.25)	-- RIGHT
...
function interface.setlevel()
	...
	send_input(":KEY1", 0x8000, 0.25)	-- CL
	send_input(":KEY1", 0x8000, 0.25)	-- CL
	send_input(":KEY2", 0x4000, 0.25)	-- DOWN
	send_input(":KEY1", 0x4000, 0.25)	-- RIGHT
	send_input(":KEY1", 0x4000, 0.25)	-- RIGHT
...
function interface.setup_machine()
	...
	send_input(":KEY1", 0x8000, 0.5)	-- CL
	send_input(":KEY2", 0x4000, 0.5)	-- DOWN
