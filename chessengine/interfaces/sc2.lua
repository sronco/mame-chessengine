...
function interface.send_pos(p)
	if     (p == 1)	then	send_input(":LINE2", 0x10, 1)
	elseif (p == 2)	then	send_input(":LINE2", 0x20, 1)
	elseif (p == 3)	then	send_input(":LINE2", 0x40, 1)
	elseif (p == 4)	then	send_input(":LINE2", 0x80, 1)
	elseif (p == 5)	then	send_input(":LINE3", 0x10, 1)
	elseif (p == 6)	then	send_input(":LINE3", 0x20, 1)
	elseif (p == 7)	then	send_input(":LINE3", 0x40, 1)
	elseif (p == 8)	then	send_input(":LINE3", 0x80, 1)
	end
end
